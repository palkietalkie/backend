...
from app.notifications.milestone import celebrate_streak_milestone as mod
from app.notifications.milestone.celebrate_streak_milestone import celebrate_streak_milestone
