"""Ask Gemma to produce a CAPITAL-SYLLABLES pronunciation hint for a display name, calibrated to the target language the AI tutor will be speaking.
...
We auto-fill once on display_name change so users don't have to know what IPA is; they can still override in Profile.
"""
...
async def guess_name_pronunciation(display_name: str, target_language: LanguageName) -> str:
