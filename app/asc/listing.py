...
Two ASC resources own different fields: name + subtitle live on `appInfoLocalizations` (the App Store product header); description + keywords + promotionalText + supportUrl + marketingUrl live on `appStoreVersionLocalizations` (per-version; promotionalText updates without a new build).
