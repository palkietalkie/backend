...
REVIEW_NOTES = (
    'Sign-in is required. On the first screen, tap "Sign in with Apple" to create an account: '
    "no demo username or password is needed. The app runs on the free tier (10 min/day, "
    "30 min/week), so no purchase is required to review every feature. Grant microphone "
    "permission when prompted; the AI speaks first automatically once a conversation starts."
)
